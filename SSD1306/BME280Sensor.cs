...
namespace BoschDevices
{
    ...
    // from https://github.com/DanielGlidewell/WeatherStation/blob/master/BoschDevices/BME280Sensor.cs
    // originally from https://github.com/ms-iot/adafruitsample/blob/master/Lesson_203V2/FullSolution/BME280.cs
    public class BME280Sensor
    {
        #region Attributes

        private bool init = false;                           // Variable to check if device is initialized
        private I2CBusPI bus;
        private I2CDevicePI bme280 = null;                    // Create an I2C device        
        private const byte BME280_Address = 0x76;           // Slave address for the BME280 - used to find the device on the I2C bus
